...
// Add - adds product to the product table
func (p ProductData) Add(product Product) (int, error) {
...
func (p ProductData) Update(id int, unitPrice string) error {
...
func (p ProductData) Delete(id int) error {
